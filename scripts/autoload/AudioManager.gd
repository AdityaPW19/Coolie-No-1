...
func _on_level_started(_level_number: int):
	...
	play_music(GameConstants.AUDIO.LevelBgm, 0.2, true, -10)  # Full volume

func _on_delivery_timer_started(_allotted_time: float):
	"""Called when a timed delivery starts. Plays the tense delivery music."""
	play_music(GameConstants.AUDIO.Level1DeliveryMusic, 0.2, true, -10)  # Full volume
...
func _on_delivery_succeeded(_delivery_data, _points):
	...
	play_sfx(GameConstants.AUDIO.delivery_success)
	play_music(GameConstants.AUDIO.LevelBgm, 0.2, true, 0.0)
...
func _on_delivery_failed(_delivery_data):
	...
	play_sfx(GameConstants.AUDIO.delivery_fail)
	play_music(GameConstants.AUDIO.LevelBgm, 0.2, true, 0.0)
...
func _on_level_complete(_level_num, _score, _successes, _total):
	...
	play_sfx(GameConstants.AUDIO.level_complete)
...
func play_button_click():
	...
	play_sfx(GameConstants.AUDIO.buttonCLick, -5.0)  # Slightly quieter for UI
